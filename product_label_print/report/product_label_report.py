...
class ReportProductTemplateLabel(models.AbstractModel):
    _name = 'report.product_label_print.report_producttemplatelabel'
    _description = 'Product Label Report'

    def _get_report_values(self, docids, data):
        test = _prepare_data(self.env, data)
        print('testing', test)
        return _prepare_data(self.env, data)

class ReportProductTemplateLabelsahil(models.AbstractModel):
    _name = 'report.product_label_print.report_producttemplatelabel_sahil'
    _description = 'Product Label Report'
